				...
				<div id="content" class="span10">
					...
					<div>
						<ul class="breadcrumb">
						 ...
						 Input module's name : <br><br>
						 <form action="checkModules.action" method="post">
        			     <textarea  id="channel_keywords" rows="10" style="width: 800px"  name="modulesNames"></textarea>
        			     <br/>
        			     请输入您的邮箱：<input type="text" name="email" value="" />
        			     <input type="submit"  value="check modules and report send to email" name="" />  任务完成后会自动发送结果到您的邮件。
						</form>
						...
						<button id="toggle-fullscreen"
							...
							data-toggle="button">
							check ALL modules and create Log4J
						</button>
