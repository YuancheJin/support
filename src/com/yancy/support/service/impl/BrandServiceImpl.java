...
public class BrandServiceImpl implements BrandService{
	...
	public Modules findModuleByScope(String scope) throws Exception{
		return moduleDao.findByScope(scope);
	}
	...
	public Integer findDynamoNum(Modules module) throws Exception {
		...
		int n=dms.queryBuzzDistributionByDay(module, DateUtil.getTSDA(1)[0], DateUtil.getTSDA(1)[1], DateUtil.getTSDA(1)[2]);
	...
	public Integer findSolrNum(Modules module) throws Exception {
		...
		if(parentModule==null){
			n=solrService.getSolrByDay(module.getExpression(),null,module.getSites(), DateUtil.getTSDA(1)[0], DateUtil.getTSDA(1)[1], DateUtil.getTSDA(1)[2]);
		}else{
			n=solrService.getSolrByDay(module.getExpression(),parentModule.getExpression(),module.getSites(), DateUtil.getTSDA(1)[0], DateUtil.getTSDA(1)[1], DateUtil.getTSDA(1)[2]);
		}
