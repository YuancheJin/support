...
/**
 * BuzzThreads entity. @author MyEclipse Persistence Tools
 */

public class BuzzThreads implements java.io.Serializable {
	...
	/** full constructor */
	public BuzzThreads(String threadId, String scope, String topic,
			...
			Double relevance, Integer reposts, Integer comments,
			Timestamp updated, Boolean filtered, String repostTo) {
