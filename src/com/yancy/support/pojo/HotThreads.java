...
/**
 * HotThreads entity. @author MyEclipse Persistence Tools
 */

public class HotThreads implements java.io.Serializable {
	...
	/** full constructor */
	public HotThreads(String scope, String threadId, String topic, Integer day,
			Integer month, Integer year, Integer siteId, String siteName,
			String media, Timestamp date, String title, String url,
			Integer period, Long posts, Long postsInRange, Long positive,
			Long negative, Long neutral, Long positiveInRange,
