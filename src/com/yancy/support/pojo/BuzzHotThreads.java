...
/**
 * BuzzHotThreads entity. @author MyEclipse Persistence Tools
 */

public class BuzzHotThreads implements java.io.Serializable {
	...
	/** default constructor */
	public BuzzHotThreads() {
	}

	/** full constructor */
	public BuzzHotThreads(String scope, String threadId, String topic,
			Integer day, Integer month, Integer year, Integer siteId,
			String siteName, String media, Timestamp date, String title,
			String url, String period, Long posts, Long postsInRange,
			Long positive, Long negative, Long neutral, Long positiveInRange,
			Long negativeInRange, Long neutralInRange, Double relevance,
			Integer reposts, Integer comments, Timestamp updated,
			Boolean filtered, String repostTo) {
		this.scope = scope;
