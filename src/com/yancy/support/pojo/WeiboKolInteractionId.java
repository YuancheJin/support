...
/**
 * WeiboKolInteractionId entity. @author MyEclipse Persistence Tools
 */

public class WeiboKolInteractionId implements java.io.Serializable {
	...
	/** default constructor */
	public WeiboKolInteractionId() {
	}

	/** full constructor */
	public WeiboKolInteractionId(String cuserId, String userId, String period,
			String userName, String city, String province, String gender,
			Integer followersCount, Integer favouritesCount,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WeiboKolInteractionId))
			return false;
		WeiboKolInteractionId castOther = (WeiboKolInteractionId) other;
