...
/**
 * BuzzTodayHotThreads entity. @author MyEclipse Persistence Tools
 */

public class BuzzTodayHotThreads implements java.io.Serializable {
	...
	/** default constructor */
	public BuzzTodayHotThreads() {
	}

	/** full constructor */
	public BuzzTodayHotThreads(String scope, String threadId, String topic,
