...
/**
 * FacebookHotThreads entity. @author MyEclipse Persistence Tools
 */

public class FacebookHotThreads implements java.io.Serializable {
	...
	/** default constructor */
	public FacebookHotThreads() {
	}

	/** full constructor */
	public FacebookHotThreads(String scope, String threadId, Integer comments,
			Float sortValue, Integer year, Integer month, Integer day,
			Long createdAt, String title, String url,
			String positiveTagsString, String predictTagsString, String topic,
			String siteName, String meida, Integer siteId, Integer version) {
		this.scope = scope;
