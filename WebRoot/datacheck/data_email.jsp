...
.sidebar-nav {
	...
	<body>
				...
				<div class="span2 main-menu-span">
					<div class="well nav-collapse sidebar-nav">
						<ul class="nav nav-tabs nav-stacked main-menu">
							...
							<li>
								<a class="ajax-link" href="data_email.jsp"><i
							...
							<li>
								<a class="ajax-link" href="data_month.jsp"><i
									class="icon-align-justify"></i><span class="hidden-tablet">HistoricalEmail</span>
								</a>
							</li>
							<li>
     ...
     <div class="container">
		<section id="examples">
      		<form name="form1" action="checkModulesByUserEmail.action" method=""post"">
            待检查的客户邮箱：<input type="text" name="userEmails"  value="imf@wildfire.asia,retailer@wildfire.asia" 
            data-role="tagsinput" /><br/>
            日志接收邮箱：<input type="text"  name="email"  value="it@wildfire.asia,data@wildfire.asia" data-role="tagsinput" />
            <div align="center">
