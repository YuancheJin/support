...
.sidebar-nav {
	...
	<body>
     ...
     <div class="container">
      <section id="examples">
      		<br/>
      		<form name="form2" action="checkDataByMonth.action" method="post">
      		可疑数据的年份:<input type="text" name="year"/>
      		月份:<input type="text" name="month"/>
      		待查天数:<input type="text" name="day"/><br/>
            ...
            <div align="center">
            <a class="btn btn-primary" onclick="go2()">
