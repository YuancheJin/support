...
.sidebar-nav {
	...
	<body>
     ...
     <div class="container">
		<section id="examples">
      		<form name="form1" action="setting.action" method="post">
            待检测的账号：<input type="text" name="wildfire_email"  value="${ wildfire_email}"  
            data-role="tagsinput" /><br/>
            日志接收邮箱：<input type="text"  name="user_email""  value="${user_email }"  data-role="tagsinput" />
            <div align="center">
            <a class="btn btn-primary" onclick="go()">
            <i class="icon-download-alt icon-white"></i> 保存/刷新
          	</a>
          	</div>
            </form>
